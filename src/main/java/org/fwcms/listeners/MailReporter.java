...
public class MailReporter implements IReporter{
	...
	private void generateNewIndex(List<ISuite> suites,String outputDirectory){
	    ...
	    try{
	    	...
	    	body.append("Hi,<br/> Execution Summary Report is in below mentioned location.<br/><br/>Ip Address : "+Commons.getSystemIpAddress()+"<br/>Folder Path : "+outputDirectory+"\\FWCMSeVDR-Suites-Summary-Index.html"+"<br/><br/> Regards,<br/>Selenium Automation Team");
