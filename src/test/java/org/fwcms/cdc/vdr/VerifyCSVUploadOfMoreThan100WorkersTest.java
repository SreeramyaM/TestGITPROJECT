...
public class VerifyCSVUploadOfMoreThan100WorkersTest extends VDRInitiator {
	...
	public Object[][] vdrApplicationData() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(VerifyCSVUploadOfMoreThan100WorkersTest.class.getResource("/org/fwcms/cdc/vdr/vdrValidationData.json").getFile()));
	...
	public void testCSVUploadOfMoreThan100Workers(HashMap<String, String> data) throws Exception {
		wdCSVFilePath=System.getProperty("user.dir")+"\\src\\test\\resources\\org\\fwcms\\cdc\\vdr\\csvValidations\\wd_110_NNS.csv";
		...
		workerSelection.verifyCSVRecordCountErrorMessage(vdrApplicationPageProp.getCSVRecordCountExceededErrorMessage());
