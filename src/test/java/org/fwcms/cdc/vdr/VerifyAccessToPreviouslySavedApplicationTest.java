...
public class VerifyAccessToPreviouslySavedApplicationTest extends VDRInitiator {
	...
	public Object[][] vdrApplicationData() throws Exception {
		JSONArray ja = (JSONArray) new JSONParser()
				.parse(new FileReader(
						VerifyAccessToPreviouslySavedApplicationTest.class
								.getResource(
	...
	public void testAccessToPrevioulsySavedApplication(HashMap<String, String> data)
			throws Exception {
